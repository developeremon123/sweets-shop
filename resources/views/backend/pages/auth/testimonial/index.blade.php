...
<div class="row">
    <div class="col-12">
        <h4>Testimonial List Table</h4>
        <div class="d-flex justify-content-end">
            <a href="{{ route('admin.testimonial.create') }}" class="btn btn-primary"><i class="fa-solid fa-plus"></i>Add New Testimonial</a>
        </div>
    </div>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{ route('admin.testimonial.edit',$testimonial->client_name_slug) }}"><i class="fa-solid fa-pen-to-square"></i>Edit</a></li>
                                    <li>
                                        <form action="{{ route('admin.testimonial.destroy',$testimonial->client_name_slug) }}" method="post">
                                            @csrf
                                            @method('DELETE')
