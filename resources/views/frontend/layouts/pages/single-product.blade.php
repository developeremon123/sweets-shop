...
@section('content')
    @include('frontend.layouts.inc.breadcrump', ['pagename' => $product->name])
            ...
            <div class="row">
                    ...
                    <div class="product-single-img">
                        <div class="product-active owl-carousel">
                            ...
                            @foreach ($product->productImage as $images)
                                <div class="item">
                                    <img src="{{ asset('upload/product') }}/{{ $images->product_multiple_image }}"
                                        alt="">
                                </div>
                            @endforeach
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="product-single-content">
                        ...
                        <ul class="socil-icon">
                            <li>Share :</li>
                            <li><a href="https://www.facebook.com/profile.php?id=100048918460282"><i
                                        class="fa fa-facebook"></i></a></li>
                            <li><a href="https://twitter.com/MdEmon71743358"><i class="fa fa-twitter"></i></a></li>
                            <li><a href="https://www.linkedin.com/in/md-emon-hossain-966565263/"><i
                                        class="fa fa-linkedin"></i></a></li>
                            <li><a href="https://www.instagram.com/emonhossain37673/"><i class="fa fa-instagram"></i></a>
                            </li>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="featured-product-wrap">
                            <div class="featured-product-img">
                                <img src="{{ asset('upload/product') }}/{{ $related_product->product_image }}"
                                    alt="">
                            </div>
                            <div class="featured-product-content">
                                <div class="row">
                                    <div class="col-7">
                                        <h3><a
                                                href="{{ route('productdetail.page', $related_product->slug) }}">{{ $related_product->name }}</a>
                                        </h3>
