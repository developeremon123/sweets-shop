...
@section('content')
@include('frontend.layouts.inc.breadcrump',['pagename'=>'Shop'])
<!-- product-area start -->
                                ...
                                <div class="product-img">
                                    ...
                                    <div class="product-icon flex-style">
                                        <ul>
                                            ...
                                            <li><a href="{{ route('productdetail.page',$product->slug) }}"><i class="fa fa-shopping-bag"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        @foreach ($category->products as $cproduct)
                            <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                <div class="product-wrap">
                                    <div class="product-img">
                                        <span>Sale</span>
                                        <img src="{{ asset('upload/product') }}/{{ $cproduct->product_image }}"
                                            alt="">
                                        <div class="product-icon flex-style">
                                            <ul>
                                                <li><a data-toggle="modal" data-target="#exampleModalCenter"
